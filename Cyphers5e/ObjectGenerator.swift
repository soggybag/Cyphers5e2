...
class ObjectGenerator {
  ...
  class func randomStringFromArray(array: [String]) -> String {
    let r = array.count
    let n = GKRandomSource.sharedRandom().nextInt(upperBound: r)
  ...
  class func getAdjective() -> String {
    return randomStringFromArray(array: adjectiveList)
  }
  
  // Get random origin 
  
  class func getOrigin() -> String {
    return randomStringFromArray(array: originList)
  }
  
  // Get Random type 
  
  class func getType() -> String {
    return randomStringFromArray(array: types)
  }
